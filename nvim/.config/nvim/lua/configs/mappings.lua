...
vim.api.nvim_set_keymap('i', '<m-j>', '<c-\\><c-n><c-w>j', { noremap = true })
vim.api.nvim_set_keymap('i', '<m-k>', '<c-\\><c-n><c-w>k', { noremap = true })
vim.api.nvim_set_keymap('i', '<m-l>', '<c-\\><c-n><c-w>l', { noremap = true })
vim.api.nvim_set_keymap('i', '<m-h>', '<c-\\><c-n><c-w>h', { noremap = true })
